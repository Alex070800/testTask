...
export class HttpClient<SecurityDataType = unknown> {
  public baseUrl: string = "https://child-test";
  ...
  constructor(apiConfig: ApiConfig<SecurityDataType> = {}) {
    Object.assign(this, { ...apiConfig, headers: {} });
  }
  ...
  public request = async <T = any, E = any>({
    ...
    return this.customFetch(
      ...
      if (r.status == 401 && r.url.includes("sign-in")) {
        return r;
      }
...
/**
 * @title Имитация сгенерированного API на основе Swagger Open API
 * @version v0
 * @baseUrl https://child-test
 */
export class Api<
